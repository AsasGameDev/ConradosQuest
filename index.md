...
A Torre do mago é um lugar perigoso e secreto, onde cada andar é dedicado a um novo desafio elemental, seus caminhos nunca são os mesmos, e a cada novo desafio novos segredos e transformações são desbloqueadas.
...
* **`Plataforma:`** PC, Web  
* **`Público:`** fãs de jogos do zelda 2D.
* **`Tempo:`** 1~2 horas.  
...
Já o combate é focado na simplicidade, com ataques físicos rápidos, e a possibilidade de esquivar, defender, ripostar ou refletir ataques específicos, grandemente alterado pelas transformações em dragão, que te permitem alterar os ataques, atacar de longe, aumentam sua resistência e ataques específicos, bem como mudam a forma como você se movimenta dentro da torre.
